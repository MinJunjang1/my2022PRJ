...
public class DetailData2 {
    ...
    public static void main(String args[]) throws MalformedURLException,
            IOException {
        HttpURLConnection conn = (HttpURLConnection) new URL("http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcRHTrade?serviceKey=ZRSyL0r8ICOuGWAMN7D6Q2LkcS8pgYf%2FREi6WHhsy%2BaKotLgDmgl1EnmMFG2hl%2Fy09nYgQMi1xf1cPeCt1BC2Q%3D%3D&LAWD_CD=11110&DEAL_YMD=202208").openConnection();
        conn.connect();
        ...
        for(int i = 0; i <= Array3.length()-1; i++) {
            ...
            String Apartment_Name = (String)apiobj.get("연립다세대");
